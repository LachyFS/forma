...
surface albedo uses the current opaque material's linear base color, including
metallic reflectivity. Normals retain their signed components. Guide sums reset,
...
soften reflections or small details at very low sample counts. More samples still
